 ...
 * @example
 * <caption>ViewModelRandomDocuments</caption>
 * const viewModel = ViewModelRandomDocuments.callback(viewModel, context);
 */
declare class ViewModelRandomDocuments {
    /**
     * The configuration key for plugin to look for in the provided configuration.
     * @example
     * <caption>ViewModelRandomDocuments.configKey</caption>
     ...
     * @example
     * <caption>ViewModelRandomDocuments.defaultConfig()</caption>
     * const config = { ...ViewModelRandomDocuments.defaultConfig(), ...context.config[ViewModelRandomDocuments.configKey] };
     ...
     * @example
     * <caption>ViewModelRandomDocuments.validateConfig(config, _context)</caption>
     * ViewModelRandomDocuments.validateConfig({ ... });
     * @param config - A configuration object.
     * @param config.configKey - A configuration object specifically for this plugin.
     * @param config.configKey.key - The that will be added to the passed in object and returned with the random documents.
     ...
     * @example
     * <caption>ViewModelRandomDocuments.callback(viewModel, context)</caption>
     * const context = {
     *   config: {
     *     [ViewModelRandomDocuments.configKey]: {
     *       ...,
     ...
     * @param context.config.ignore_slugs - A list of slugs to not consider when fetching random documents.
     * @param context.hooks - An event system / hook system to use.
     * @param context.hooks.on - An event registration function.
